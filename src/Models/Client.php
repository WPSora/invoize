...
class Client extends WPPost
{
    ...
    private function sendMail(string $name, string $email, string $pw)
    {
        ...
        $content =
            ...
            <br/><br/>Please change your password at your earliest convenience for security purposes by clicking <a href='{{reset_url}}'>here.</a>
    ...
    public static function createFromWcCustomer(array $customer)
    {
        ...
        Client::setMeta($client->ID, $clientMetas);
