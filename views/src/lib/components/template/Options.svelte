...
<DiscountModal bind:isOpen={isDiscountModalOpen} bind:isLoading={isLoadingDiscount} bind:payload={discountData} bind:temporaryEdit={discountTemporaryEdit}/>
              ...
              <AccordionContent>
                ...
                {:else}
                  <div class="flex flex-row justify-between mb-3 gap-3">
                    <!-- Reminder Before -->
                    <div class="space-y-3">
                      <div class="font-medium w-full underline">Before Due Date</div>
                    ...
                    <!-- Reminder After -->
                    <div class="space-y-3">
                      <div class="font-medium w-full underline">After Due Date</div>
                      {#each $reminders as reminder}
                        <div class="flex flex-row items-center gap-x-2 mb-3">
                          <Checkbox
                            id={reminder + " after"}
