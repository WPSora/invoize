<script>
  ...
  import { invoiceContent, receiptContent } from "$lib/common/class-constant";
...
<Card
  class="sm:p-8 p-3 print:p-2 md:w-[800px] min-h-[900px] invoice-content-wrapper {isReceipt &&
    'hidden'} print:border-none print:shadow-none print:w-full">
  <!-- this ID used by html2pdf -->
  <div id={isReceipt ? receiptContent : invoiceContent}>
    ...
    <CardContent class="sm:py-2 px-0 space-y-6">
      ...
      <div class="flex flex-nowrap justify-between">
        ...
        <div class="w-1/2 space-y-6">
          ...
          <!-- Customer -->
          <Customer client={invoice.client} hasBilledTo={!invoice.billedToSameAsClient}/>
          
          {#if !invoice.billedToSameAsClient}
            <!-- Billed to -->
      ...
      <div class="flex flex-row flex-nowrap">
        <!-- Content Bottom-Left -->
        <Payment payments={invoice.payments} {isPaid} {isRecurring} />
    ...
    <!-- Note & TC -->
    <CardFooter class="block px-0 pb-0 mt-10 break-inside-avoid">
