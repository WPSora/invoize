    ...
    {:else}
      ...
      <form on:submit|preventDefault={submit} class="flex flex-col gap-4">
        <div class="flex flex-col gap-5">
          <div class="flex flex-col flex-nowrap gap-2 items-start w-80">
          ...
          <div class="flex flex-col flex-nowrap gap-2 items-start w-80">
            <Label for="on-status" class="md:text-sm text-xs">Update Invoice to Paid</Label>
          ...
          {#if !disableSendInvoiceOnPaidInput}
            <div transition:slide class="flex flex-row flex-nowrap justify-between gap-2 w-80 mb-2">
