...
/**
 * This store file is purely used to store the state of the invoice form input,
 */
 ...
 */
export let invoiceNumber = writable("");
...
/** @type {import('svelte/store').Writable<boolean>} */
export let reminderForClient = writable(false);

/** @type {import('svelte/store').Writable<boolean>} */
export let reminderForAdmin = writable(false);