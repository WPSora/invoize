...
export default {
  ...
  "/invoice/create": wrap({
    asyncComponent: () => import("./routes/invoice/create/CreateInvoice.svelte"),
    loadingComponent: CircleLoading,
  }),
  ...
  "/recurrings": wrap({
    asyncComponent: () => import("./routes/recurring/RecurringClientList.svelte"),
    loadingComponent: SkeletonLoading,
  }),
  "/recurring/create": wrap({
    asyncComponent: () => import("./routes/recurring/create/CreateRecurring.svelte"),
    loadingComponent: CircleLoading,
  }),
  ...
  "/recurring/edit/:invoizeToken": wrap({
    asyncComponent: () => import("./routes/recurring/edit/EditRecurring.svelte"),
    loadingComponent: CircleLoading,
  }),
  "/recurring/:clientId": wrap({
    asyncComponent: () => import("./routes/recurring/detail/RecurringList.svelte"),
    loadingComponent: SkeletonLoading,
  }),
  "/recurring/:clientId/:invoizeToken": wrap({
    asyncComponent: () => import("./routes/recurring/detail/preview/RecurringPreview.svelte"),
    loadingComponent: CircleLoading,
  }),
  "/receipts": wrap({
