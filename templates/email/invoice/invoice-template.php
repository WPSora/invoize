...
$previewLink    = get_site_url() . '/invoize-preview?invoizeToken=' . $invoice->getToken();
  ...
  <div style="min-height: 900px;">
    ...
    <table style="width: 100%;">
      ...
      <?php if ($page == Invoice::INVOICE) : ?>
        <tr>
          <td style="text-align: right; font-size: 20px;">
            <?php echo esc_html($invoice->getInvoiceNumber()) ?>
          </td>
        </tr>
      ...
      <?php elseif ($page == Invoice::RECEIPT) : ?>
        <tr>
          <td style="text-align: right; font-size: 20px;">
            <?php echo esc_html($invoice->receipt->getReceiptNumber()); ?>
          </td>
        </tr>
        <tr>
    ...
    <table style="width: 100%; font-size: 14px;margin-bottom:14px;">
      <tr>
        <td style="width: 50%; font-size: 14px; font-weight: bold;">
          <?php if ($invoice->isBilledToSameAsClient()): ?>
            Customer
          <?php else: ?>
            Bill to
          <?php endif; ?>
        ...
        <td style="width: 2%; text-align: center;">:</td>
        <td style="width: 23%; text-align: right;">
          <?php echo esc_html(invoizeFormatDate($invoice->getOrderDate(), $dateFormat)); ?>
        </td>
      </tr>
      ...
      <tr>
        <td style="width: 50%; font-size: 14px;">
          ...
          <?php else: ?>
            <?php echo esc_html($invoice->getBilledTo()['name']); ?>
          <?php endif; ?>
        </td>
        <!-- Invoice date -->
        <td style="width: 7.5%;"></td>
        <td style="width: 17.5%;">Invoice date</td>
        <td style="width: 2%; text-align: center;">:</td>
        <td style="width: 23%; text-align: right;">
          <?php echo esc_html(invoizeFormatDate($invoice->getInvoiceDate(), $dateFormat)) ?>
        </td>
      </tr>
      ...
      <tr>
        <td style="width: 50%; font-size: 12px; color: #64748b;">
          ...
          <?php else: ?>
            <?php echo nl2br(wp_kses_post($invoice->getBilledTo()['detail'])); ?>
          <?php endif; ?>
        </td>
        <!-- Due date -->
        <td style="width: 7.5%;"></td>
        ...
        <td style="width: 2%; text-align: center;">:</td>
        <td style="width: 23%; text-align: right;">
          <?php echo esc_html(invoizeFormatDate($invoice->getDueDate(), $dateFormat)) ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <?php if ($paymentStatus == Invoice::PAID) : ?>
          ...
          <td style="width: 2%; text-align: center;">:</td>
          <td style="width: 23%; text-align: right;">
            <?php echo esc_html(invoizeFormatDate($invoice->getPaidDate(), $dateFormat)); ?>
          </td>
        <?php endif ?>
      </tr>
    </table>
